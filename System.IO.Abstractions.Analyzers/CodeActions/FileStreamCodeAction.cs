...
/// <summary>
/// Code action to replace a <see cref="FileStream"/> with a IFileSystem.File.Create call.
/// </summary>
public class FileStreamCodeAction(
	string title,
	Document document,
	...
	: CodeAction
{
	...
	protected override async Task<Document> GetChangedDocumentAsync(CancellationToken cancellationToken)
	{
		...
		editor.ReplaceNode(creationExpressionSyntax,
			SF.ParseExpression($"{field.Declaration.Variables.ToFullString()}.FileStream.New({string.Join(",", arguments)})"));
